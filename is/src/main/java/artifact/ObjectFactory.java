...
public class ObjectFactory {
    ...
    private final static QName _SetParamsResponse_QNAME = new QName("http://ws/", "setParamsResponse");
    private final static QName _SetParams_QNAME = new QName("http://ws/", "setParams");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws/", name = "setParamsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws/", name = "setParams")
