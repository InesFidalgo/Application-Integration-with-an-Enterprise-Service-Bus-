...
<body>
		<div class="w3-container">
			<form class="w3-form" method="post" action="Professores">
                <input type="hidden" name="order" value="1" />
				<div class="w3-row">
			<div class="w3-col w3-half">
				<div class="w3-container">
					<h3>Registar Professor</h3>
                        ...
                        <div class="w3-input-group">
							<label>Data</label>
							<input class="w3-input" name="data" type="text" required/>
						</div>
...
<div class="w3-input-group">
							<label>Salario</label>
							<input class="w3-input" name="salario" type="number" required/>
						</div>
                        <br>
